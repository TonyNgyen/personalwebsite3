...
function Page() {
  return (
    <BlogContainer>
      ...
      <BlogSection>
        It&lsquo;s been about a month of summer so far, and I&lsquo;ve been busy with some
        projects, a job, and a potential start up! I haven&lsquo;t had much time to
      ...
      <BlogSection>
        ...
        need to do more research about that. But other than that, I haven&lsquo;t had
      ...
      <BlogSection>
        Finally... I&lsquo;ve been working at a coffee/boba shop! It&lsquo;s been an okay
      ...
      <BlogSection>
        That&lsquo;s about it for now! I will try to write more blogs and notes
